...
Shader "KY/lit_burnt" {
    Properties {
        ...
        _OclipCorrect ("OclipCorrect", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip((_node_6292_var.a-(_OclipCorrect*i.vertexColor.a)) - 0.5);
...
////// Specular:
                ...
                float4 node_4524 = _Time + _TimeEditor;
                float2 node_8511 = (i.uv0+node_4524.g*float2(0,0.02));
                float3 _node_921_var = UnpackNormal(tex2D(_node_921,TRANSFORM_TEX(node_8511, _node_921)));
                float2 node_3898 = (i.uv0+node_4524.g*float2(-0.02,0.05));
                float3 _node_8617_var = UnpackNormal(tex2D(_node_8617,TRANSFORM_TEX(node_3898, _node_8617)));
                float2 node_7441 = (i.uv0+node_4524.g*float2(0.03,-0.03));
...
////// Specular:
                ...
                float specularMonochrome;
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float4 node_6785 = _Time + _TimeEditor;
                float2 node_8511 = (i.uv0+node_6785.g*float2(0,0.02));
                float3 _node_921_var = UnpackNormal(tex2D(_node_921,TRANSFORM_TEX(node_8511, _node_921)));
                float2 node_3898 = (i.uv0+node_6785.g*float2(-0.02,0.05));
                float3 _node_8617_var = UnpackNormal(tex2D(_node_8617,TRANSFORM_TEX(node_3898, _node_8617)));
                float2 node_7441 = (i.uv0+node_6785.g*float2(0.03,-0.03));
                float3 _node_5202_var = UnpackNormal(tex2D(_node_5202,TRANSFORM_TEX(node_7441, _node_5202)));
                float node_4049 = (((_node_921_var.rgb+_node_8617_var.rgb)+_node_5202_var.rgb)/2.0).r;
                float2 node_729 = (i.uv0+node_4049);
                float4 _node_2180_var = tex2D(_node_2180,TRANSFORM_TEX(node_729, _node_2180));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float4 node_3976 = _Time + _TimeEditor;
                float2 node_8511 = (i.uv0+node_3976.g*float2(0,0.02));
                float3 _node_921_var = UnpackNormal(tex2D(_node_921,TRANSFORM_TEX(node_8511, _node_921)));
                float2 node_3898 = (i.uv0+node_3976.g*float2(-0.02,0.05));
                float3 _node_8617_var = UnpackNormal(tex2D(_node_8617,TRANSFORM_TEX(node_3898, _node_8617)));
                float2 node_7441 = (i.uv0+node_3976.g*float2(0.03,-0.03));
                float3 _node_5202_var = UnpackNormal(tex2D(_node_5202,TRANSFORM_TEX(node_7441, _node_5202)));
                float node_4049 = (((_node_921_var.rgb+_node_8617_var.rgb)+_node_5202_var.rgb)/2.0).r;
                float2 node_729 = (i.uv0+node_4049);
                float4 _node_2180_var = tex2D(_node_2180,TRANSFORM_TEX(node_729, _node_2180));
