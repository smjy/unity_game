...
////// Emissive:
                ...
                float node_673 = (lerp( pow(((_baseTex_var.r+_baseTex_var.g+_baseTex_var.b)/3.0),_alphaDensity), pow(_baseTex_var.a,_alphaDensity), _haveAlpha )*_alphaPower*lerp( 1.0, saturate((sceneZ-partZ)/_depthBlend), _useDepthBlend )*node_1946.r);
                float3 emissive = (pow(lerp( ((_baseTex_var.r+_baseTex_var.g+_baseTex_var.b)/3.0), _baseTex_var.rgb, _useTexColor ),_texDensity)*_emissive*i.vertexColor.rgb*node_673);
