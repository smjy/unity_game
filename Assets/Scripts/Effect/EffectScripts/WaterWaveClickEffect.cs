...
public class WaterWaveClickEffect : PostEffectBase {
    ...
    public static WaterWaveClickEffect main = null;
    ...
    public void exec(Vector2 screen_pos) {
        Vector2 mousePos = screen_pos;
        //将mousePos转化为（0，1）区间
        startPos = new Vector4(mousePos.x / Screen.width, mousePos.y / Screen.height, 0, 0);
        waveStartTime = Time.time;
    }
