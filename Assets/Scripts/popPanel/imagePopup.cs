...
public class imagePopup : MonoBehaviour {
    ...
    Image[] myImg;  //0-4 panel 返回按钮 确认按钮 取消按钮 图片
    public Sprite nor, high, nor_back, high_back;
    /*内容字号默认为18*/
    public static imagePopup main;
    void Awake()
    {
        main = this;
    }
    //无确认取消按钮
    //修改标题、内容 
    public GameObject pop(string title, string content, Sprite img)
    {
        ...
        //设置内容图片
        myImg = myPanel.GetComponentsInChildren<Image>();
        Color opa1 = new Color(1, 1, 1, 1.0f);
        myImg[4].sprite = img;
        myImg[4].color = opa1;
        //返回按钮
    ...
    //无确认取消按钮
    //修改标题、内容、内容的字号
    public GameObject pop(string title, string content, Sprite img,int fSize)
    {
        myPanel = GameObject.Instantiate(prePanel) as GameObject;
        myPanel.transform.SetParent(GameObject.Find("Canvas").transform, false);
        //设置标题名称和内容
    ...
    public GameObject pop(string title, string content, Sprite img, int fSize,float scaleWidth, float scaleHeight)
    {
        myPanel = GameObject.Instantiate(prePanel) as GameObject;
        myPanel.transform.SetParent(GameObject.Find("Canvas").transform, false);
        //设置标题名称和内容
    ...
    //无确认取消按钮
    //修改标题、内容、字号、背景图
    public GameObject pop(string title, string content, Sprite img, int fSize,Sprite bg)
    {
        myPanel = GameObject.Instantiate(prePanel) as GameObject;
        myPanel.transform.SetParent(GameObject.Find("Canvas").transform, false);
        //设置标题名称和内容
    ...
    //有确认取消按钮
    //修改标题、文字内容
    public GameObject popHaBtn(string title, string content, Sprite img)
    {
        ...
        Color32 highcolor = new Color32(137, 133, 185, 255);
        Color32 norcolor = new Color32(133, 146, 247, 255);
    ...
    //有确认取消按钮
    //修改标题、文字内容
    public GameObject popHaBtn(string title, string content, Sprite img,int fSize)
    {
    ...
    //有确认取消按钮
    //修改标题、内容、字号、设置面板缩放量
    public GameObject popHaBtn(string title, string content, Sprite img,int fSize,float scaleWidth, float scaleHeight)
    {
        myPanel = GameObject.Instantiate(prePanel) as GameObject;
        myPanel.transform.SetParent(GameObject.Find("Canvas").transform, false);
        //设置标题名称和内容
    ...
    //无图片、有确认取消按钮
    //修改标题、内容、字号、背景图
    public GameObject popHaBtn(string title, string content, Sprite img,int fSize,Sprite bg)
    {
        myPanel = GameObject.Instantiate(prePanel) as GameObject;
        myPanel.transform.SetParent(GameObject.Find("Canvas").transform, false);
        //设置标题名称和内容
